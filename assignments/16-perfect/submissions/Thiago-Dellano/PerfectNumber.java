...
public class PerfectNumber {
    ...
    // Método para obter os fatores próprios de um número
    ...
    public static void main(String[] args) {
        ...
        // Permite ao usuário testar um número maior que 1000
        Scanner scanner = new Scanner(System.in);
        System.out.print("\nDigite um número para verificar se é perfeito: ");
        int number = scanner.nextInt();
        
        if (isPerfect(number)) {
            System.out.println(number + " é um número perfeito. Fatores: " + getFactors(number));
        } else {
